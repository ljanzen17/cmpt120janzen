...
class Products:
    ...
    def totalCost(quantity, price):
        totCost = self.price * count
        return totCost

prods = [Products("Ultrasonic range finder", 2.50, 4),
...
def getCount():
    count = input("Enter the number of the product you would like to buy: ")

def printStock(prods):
